 ...
 * @subpackage Yotpo_Utilities/public
 */
...
class Yotpo_Utilities_Public {
	 ...
	 *
	 * @since    1.0.0
	 * @param      string    $yotpo_utilities       The name of the plugin.
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->yotpo_utilities, plugin_dir_url( __FILE__ ) . 'css/yotpo-utilities-public.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->yotpo_utilities, plugin_dir_url( __FILE__ ) . 'js/yotpo-utilities-public.js', array( 'jquery' ), $this->version, false );
